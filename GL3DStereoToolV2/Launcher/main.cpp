#include <iostream>
#include "../GL3DStereoTool/common/DLLInject.h"//DLLInject.h
#include "../GL3DStereoTool/common/GLWindow.h" //GLWindow.h
#include <GL/gl.h>
#include <GL/wglext.h>
...
int main ( int argc, char **argv )
{
    ...
    static const string moduleName( "GL3DStereoTool.dll" );
